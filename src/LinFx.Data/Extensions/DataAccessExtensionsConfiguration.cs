...
{
    public interface IDataAccessExtensionsConfiguration
    {
    ...
    public class DataAccessExtensionsConfiguration : IDataAccessExtensionsConfiguration
    {
        private readonly ConcurrentDictionary<Type, IClassMapper> _classMaps = new ConcurrentDictionary<Type, IClassMapper>();

        public DataAccessExtensionsConfiguration(Type defaultMapper, IList<Assembly> mappingAssemblies, ISqlDialect sqlDialect)
        {
