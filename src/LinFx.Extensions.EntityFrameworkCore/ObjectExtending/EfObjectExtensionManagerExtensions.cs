...
public static class EfObjectExtensionManagerExtensions
{
    ...
    {
        return objectExtensionManager.AddOrUpdate(typeof(TDbContext), options =>
        {
    ...
    {
        return objectExtensionManager.MapEfEntity(typeof(TEntity), entityTypeBuildAction);
    }
        ...
        [NotNull] Action<EntityTypeBuilder> entityTypeBuildAction)
    {
        ...
        return objectExtensionManager.AddOrUpdate(entityType, options =>
        {
