...
{
    public static bool IsMultiTenant<TEntity>() where TEntity : IEntity => IsMultiTenant(typeof(TEntity));

    public static bool IsMultiTenant(Type type) => typeof(IMultiTenant).IsAssignableFrom(type);
    ...
    public static bool EntityEquals(IEntity entity1, IEntity entity2)
    {
        ...
        if (entity1 is IMultiTenant tenant && entity2 is IMultiTenant)
        {
