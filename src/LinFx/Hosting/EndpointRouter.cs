...
namespace LinFx.Hosting
{
    public class EndpointRouter : IEndpointRouter
    {
        ...
        private readonly EndpointRouterOptions _options;
        private readonly ILogger _logger;

        public EndpointRouter(IEnumerable<Endpoint> endpoints, EndpointRouterOptions options, ILogger<EndpointRouter> logger)
        {
