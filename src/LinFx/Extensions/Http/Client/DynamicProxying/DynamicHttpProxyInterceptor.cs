...
namespace LinFx.Extensions.Http.Client.DynamicProxying;

public class DynamicHttpProxyInterceptor<TService> : Interceptor, ITransientDependency
{
    ...
    protected HttpClientOptions ClientOptions { get; }
