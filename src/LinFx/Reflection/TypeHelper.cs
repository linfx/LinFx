...
public static class TypeHelper
{
    ...
    public static object ConvertFromString<TTargetType>(string value) => ConvertFromString(typeof(TTargetType), value);
    ...
    public static object ConvertFrom<TTargetType>(object value) => ConvertFrom(typeof(TTargetType), value);

    public static object ConvertFrom(Type targetType, object value) => TypeDescriptor
        .GetConverter(targetType)
        .ConvertFrom(value);

    public static Type StripNullable(Type type) => IsNullable(type)
