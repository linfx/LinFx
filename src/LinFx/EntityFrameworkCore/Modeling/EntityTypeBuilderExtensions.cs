...
using LinFx.EntityFrameworkCore.ObjectExtending;
using LinFx.EntityFrameworkCore.ValueComparers;
using LinFx.EntityFrameworkCore.ValueConverters;
...
namespace LinFx.EntityFrameworkCore.Modeling
{
